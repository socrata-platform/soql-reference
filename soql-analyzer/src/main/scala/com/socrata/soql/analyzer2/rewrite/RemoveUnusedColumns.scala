...
class RemoveUnusedColumns[MT <: MetaTypes] private (columnReferences: Map[TableLabel[MT#DatabaseTableNameImpl], Set[ColumnLabel[MT#DatabaseColumnNameImpl]]]) extends SoQLAnalyzerUniverse[MT] {
