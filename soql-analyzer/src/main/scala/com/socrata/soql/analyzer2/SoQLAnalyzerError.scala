...
object SoQLAnalyzerError {
  ...
  sealed trait TypecheckError[+RNS] extends SoQLAnalyzerError[RNS]
  object TypecheckError {
    case class NoSuchColumn[+RNS](
      ...
      name: ColumnName,
      position: Position
    ) extends SoQLAnalyzerError[RNS](s"No such column ${name.name}") with TypecheckError[RNS] with AliasAnalysisError[RNS]
    ...
    case class UnknownUDFParameter[+RNS](
      ...
      name: HoleName,
      position: Position
    ) extends SoQLAnalyzerError[RNS](s"No such UDF parameter ${name.name}") with TypecheckError[RNS]
    ...
    case class UnknownUserParameter[+RNS](
      ...
      name: HoleName,
      position: Position
    ) extends SoQLAnalyzerError[RNS](s"No such user parameter ${view.fold("")(_.name + "/")}${name.name}") with TypecheckError[RNS]
    ...
    case class NoSuchFunction[+RNS](
      ...
      arity: Int,
      position: Position
    ) extends SoQLAnalyzerError[RNS](s"No such function ${name}/${arity}") with TypecheckError[RNS]
    ...
    case class TypeMismatch[+RNS](
      ...
      found: TypeName,
      position: Position
    ) extends SoQLAnalyzerError[RNS](s"Type mismatch: found ${found}") with TypecheckError[RNS]
    ...
    case class RequiresWindow[+RNS](
      ...
      name: FunctionName,
      position: Position
    ) extends SoQLAnalyzerError[RNS](s"${name.name} requires a window clause") with TypecheckError[RNS]
    ...
    case class NonAggregate[+RNS](
      ...
      name: FunctionName,
      position: Position
    ) extends SoQLAnalyzerError[RNS](s"${name.name} is not an aggregate function") with TypecheckError[RNS]
    ...
    case class NonWindowFunction[+RNS](
      ...
      name: FunctionName,
      position: Position
    ) extends SoQLAnalyzerError[RNS](s"${name.name} is not a window function") with TypecheckError[RNS]

    case class GroupsRequiresOrderBy[+RNS](
      scope: RNS,
      canonicalName: Option[CanonicalName],
      position: Position
    ) extends SoQLAnalyzerError[RNS](s"GROUPS mode requires and ORDER BY in the window definition") with TypecheckError[RNS]
  }

  sealed trait AliasAnalysisError[+RNS] extends SoQLAnalyzerError[RNS]
  object AliasAnalysisError {
    case class RepeatedExclusion[+RNS](
      ...
      name: ColumnName,
      position: Position
    ) extends SoQLAnalyzerError[RNS]("Column `" + name + "' has already been excluded") with AliasAnalysisError[RNS]
    ...
    case class DuplicateAlias[+RNS](
      ...
      name: ColumnName,
      position: Position
    ) extends SoQLAnalyzerError[RNS]("There is already a column named `" + name + "' selected") with AliasAnalysisError[RNS]
    ...
    case class CircularAliasDefinition[+RNS](
      ...
      name: ColumnName,
      position: Position
    ) extends SoQLAnalyzerError[RNS]("Circular reference while defining alias `" + name + "'") with AliasAnalysisError[RNS]
  }
}
