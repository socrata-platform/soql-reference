...
object Annotation {
  ...
  case class TableDefinition[MT <: MetaTypes](label: AutoTableLabel) extends Annotation[MT]
  case class ColumnRef[MT <: MetaTypes](table: AutoTableLabel, label: ColumnLabel[MT#DatabaseColumnNameImpl]) extends Annotation[MT]
